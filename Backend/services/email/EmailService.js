...
const sendRegistrationEmail = async (athlete, pdfPath) => {
...
<div style="font-family: Arial, sans-serif; max-width:700px; margin:auto; border:1px solid #ddd; border-radius:8px; overflow:hidden;">
    ...
    <div style="padding:30px;">
        ...
        <p>
            ...
            <strong>Surat District Weightlifting Championship 2026–27</strong>.
        </p>
        ...
        <table style="width:100%; border-collapse:collapse; margin:20px 0;">
            ...
            <tr>
                ...
                <td style="padding:10px; border:1px solid #ddd;">
                    ${new Date(athlete.personalInfo.dob).toLocaleDateString()}
                </td>
            </tr>
...
`;
    ...
    try {
        const response = await apiInstance.sendTransacEmail({
            ...
            sender: {
                name: "Surat District Weightlifting Association",
            ...
            to: [
                {
                    ...
                    name: athlete.personalInfo.fullName,
                },
            ],
            ...
            attachment: [
                {
                    name: `${athlete.registrationNo}.pdf`,
