...
A full-stack web application designed to manage sports competitions — from athlete registration and verification to start-list generation and live competition operations.

---

## 📌 About the Project

Organising a sports competition involves handling athlete registrations, documents, categories, start lists, officials, and competition-day operations.

This project brings these workflows into a single web-based system to reduce repetitive manual work and make competition management more organised.

The application was developed around the real workflow of a weightlifting competition, with separate experiences for administrators, competition officials, and the public.
...
The public scoreboard is read-only and designed for spectators and competition viewing.
...
- Puppeteer — browser/PDF processing
...
The system organises athletes according to competition requirements and generates the start list.
