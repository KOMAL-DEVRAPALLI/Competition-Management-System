...
import "../../components/Athlete/RegistrationSuccess/RegistrationSuccess.css";
import {
    FaCheckCircle,
    FaDownload,
    FaHome,
...
import { downloadReceipt } from "../../api/axios";
import Footer from "../../components/Athlete/Footer/Footer";
const RegistrationSuccess = () => {
  ...
  return (
    ...
    onClick={() => downloadReceipt(registration.registrationNo)}
>
    <FaDownload />
    Download Receipt
</button>
